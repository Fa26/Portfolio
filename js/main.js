...
//demolink();
    ...
    function init() {
        ...
        if(!isMobile){
            ...
            materialKnoy= 'MeshNormalMaterial';
        ...
        // geometrys
        geos['sphere'] = new THREE.BufferGeometry().fromGeometry( new THREE.TorusKnotGeometry(3,1,256,32));
        ...
        // materials
        mats['sph']    = new THREE[materialKnoy]( {shininess: 10, map: basicTexture(0), name:'sph' } );
